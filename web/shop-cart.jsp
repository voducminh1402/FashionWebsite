<%-- 
    Document   : shop-cart
    Created on : Sep 1, 2021, 11:58:54 PM
    Author     : VODUCMINH
--%>

<%@page import="fashionweb.shopping.Product"%>
                            ...
                            <tbody>                     
                                <tr>
                                    ...
                                    <td class="cart__quantity">
                                        <form action="MainController" id="cart-form">
                                            <button id="submit-form-cart" name="action" value="Modify Cart" type="submit" style="visibility: hidden; float: right"></button>
                                            <div class="pro-qty">
                                                <button type="submit" name="action" value="Modify Cart" class="dec qtybtn cart-button">-</button>
                                    ...
                                    <td class="cart__close">
                                        <button type="submit" name="action" value="Remove Cart" class="cart-remove">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="cart__btn update__btn">
                        <a id="a-tag-form" href="#"><span class="icon_loading"></span> Update cart</a>
                    </div>
                </div>
            </div>
            <div class="row">
